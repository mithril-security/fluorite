...
def main(
    ...
    front_door_name = "frontdoornynjo"
    ...
    origin_group_name = "origingroupaegdm"
    logging.info(
    ...
    # # j = {
    # #     "subname": f"{custom_domain_host}",
    # #     "type": "CNAME",
    # #     "ttl": 3600,
    # #     "records": [f"{endpoint.host_name}."],
    # # }

    # # r = session.post(f"https://desec.io/api/v1/domains/{dns_zone_name}/rrsets/", json=j)
    # # r.raise_for_status()
    # # print(r.text)
